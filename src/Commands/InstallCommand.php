...
namespace JMI\Voyager\Commands;
...
use JMI\Voyager\Traits\Seedable;
use JMI\Voyager\VoyagerServiceProvider;
...
class InstallCommand extends Command
{
    ...
    public function handle(Filesystem $filesystem)
    {
        ...
        if (file_exists(app_path('User.php'))) {
            ...
            if ($str !== false) {
                $str = str_replace('extends Authenticatable', "extends \JMI\Voyager\Models\User", $str);

                file_put_contents(app_path('User.php'), $str);
            }
        } else {
            $this->warn('Unable to locate "app/User.php".  Did you move this file?');
            $this->warn('You will need to update this manually.  Change "extends Authenticatable" to "extends \JMI\Voyager\Models\User" in your User model');
        }
