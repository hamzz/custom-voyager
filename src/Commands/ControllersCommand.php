...
class ControllersCommand extends Command
{
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/jmi/voyager/src/Http/Controllers'));
        $namespace = config('voyager.controllers.namespace', 'JMI\\Voyager\\Http\\Controllers');
    ...
    {
        return $this->filesystem->get(base_path('/vendor/jmi/voyager/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'JMI\\Voyager\\Http\\Controllers\\'.$class,
            $content
        );
